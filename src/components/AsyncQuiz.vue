<template>
  ...
  <template v-else>
    <div class="bg-red-600 rounded border-4 border-black sm:w-1/3 m-auto p-4">
      <p class="font-mono shadow-white">
        Couldn't fetch your request - please check your internet connection
      </p>
    </div>
    <router-link
      to="/"
      class="rounded border-4 m-auto p-2 sm:w-1/3 border-black bg-indigo-500 hover:bg-indigo-800"
      >Go back to main screen</router-link
    >
  </template>
</template>
